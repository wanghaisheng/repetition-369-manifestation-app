# 06 — HTML Visual Review (Repair Loop)
...
## QA Checklist
- [ ] Font family + weight + size (matches `design-system.md`)
- [ ] Border radius (all corners)
- [ ] Shadows (offset, blur, color, opacity)
- [ ] Z-order / layering
- [ ] Color tokens (no drift from `theme.json` / `color-system.json`)
...
- [ ] World-view intact: HTML still feels like `style-board.png`
...
## Gating Rule
`review.md` must be signed off (and `validation.json.pass === true`) **before** Skill 07 (React PWA) or Skill 08 (Runtime Compiler) run.
