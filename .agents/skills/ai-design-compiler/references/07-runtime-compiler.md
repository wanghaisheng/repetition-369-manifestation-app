...
## Inputs (all three permanent assets)
```
...
### HTML
Output: `html` + `css`. Same generator as Skill 04.

### React
Output: `.tsx` components + asset bindings + layout bindings. Same generator as Skill 06.
