      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">我们使用收集的信息用于：</p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              <li>提供和改进应用服务</li>
              <li>保存您的愿望和练习进度</li>
              <li>发送重要的服务通知</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">我们采用行业标准的安全措施保护您的数据：</p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              <li>数据加密传输和存储</li>
              <li>访问控制和身份验证</li>
              <li>定期安全审计和更新</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">我们使用以下第三方服务来提供更好的体验：</p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">您拥有以下权利：</p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              <li>访问和更正您的个人信息</li>
              <li>删除您的账户和相关数据</li>
              <li>导出您的数据</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">如果您对隐私政策有任何疑问，请通过以下方式联系我们：</p>
