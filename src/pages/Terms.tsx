      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">显化369是一款帮助用户通过369方法进行愿望显化练习的应用程序。我们提供：</p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">作为用户，您同意：</p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              <li>提供准确的注册信息</li>
              <li>保护账户安全和密码保密</li>
              <li>不发布违法、有害或不当内容</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">如果您对服务条款有任何疑问，请通过以下方式联系我们：</p>
